...
import { CloseIcon } from '@/shared/ui/components/atoms/Icons/Icons'
import SearchBar from '@/shared/ui/components/molecules/SearchBar/SearchBar'
import FilterPanel from '@/shared/ui/components/organisms/FilterPanel/FilterPanel'
        ...
        <Drawer.Content maxW={{ base: '100%', md: '28rem' }} position="relative">
          ...
          <Drawer.Footer borderTopWidth="1px" borderColor="border" py="sm">
            <Box display="flex" justifyContent="flex-end" w="full">
              <Button size="sm" variant="solid" colorPalette="brand" onClick={confirm}>
                Confirmer
              </Button>
            </Box>
          </Drawer.Footer>
