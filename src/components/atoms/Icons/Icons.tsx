...
export function DownloadIcon(props: SvgProps) {
  return (
    <chakra.svg viewBox="0 0 24 24" {...props}>
      <path d="M12 3v12m0 0l-4-4m4 4 4-4M4 19h16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </chakra.svg>
  );
}
...
export function FilterIcon(props: SvgProps) {
  return (
    <chakra.svg viewBox="0 0 24 24" {...props}>
      <path d="M3 5h18l-7 8v6l-4 2v-8L3 5z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
    </chakra.svg>
  );
}
