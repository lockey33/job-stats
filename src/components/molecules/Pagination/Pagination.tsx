...
export default function Pagination({ page, pageSize, pageCount, total, onPageChange, pageSizeOptions = [10, 20, 50], onPageSizeChange }: Props) {
    ...
    <HStack align="center" justify="space-between" mt="sm" fontSize="sm">
      <HStack gap="md" align="center">
        ...
        <HStack gap="xs" align="center">
          ...
          <HStack gap="xs">
            {pageSizeOptions.map((opt) => {
              ...
              return (
                <Button key={opt} size="xs" variant={active ? 'solid' : 'outline'} onClick={() => onPageSizeChange?.(opt)}>
                  {opt}
                </Button>
              );
            })}
        ...
        <HStack gap="xs" align="center">
          ...
          <Input aria-label="Aller à la page" size="sm" type="number" min={1} max={pageCount} w="4.5rem"
