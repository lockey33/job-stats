  ...
  return (
    <Box display="grid" gridTemplateColumns={{ base: '1fr', lg: '1fr 1fr' }} gap="lg">
      ...
      <Box borderWidth="0px" p={0} bg="transparent" shadow="none">
        ...
        <Box h="16rem">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={metrics.postingsPerMonth} margin={{ top: 10, right: 20, bottom: 0, left: 0 }}>
      ...
      <Box borderWidth="0px" p={0} bg="transparent" shadow="none">
        ...
        <Box h="16rem">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={metrics.avgTjmPerMonth} margin={{ top: 10, right: 20, bottom: 0, left: 0 }}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="month" />
              <YAxis />
              <Tooltip />
      ...
      <Box borderWidth="0px" p={0} bg="transparent" shadow="none" gridColumn={{ lg: '1 / -1' }}>
        ...
        <Box h="20rem">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={metrics.skillsPerMonth} margin={{ top: 10, right: 20, bottom: 0, left: 0 }}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="month" />
              <YAxis allowDecimals={false} />
              <Tooltip />
              <Legend />
              {metrics.seriesSkills.map((s, idx) => (
