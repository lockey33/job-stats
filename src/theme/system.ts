...
export const system = createSystem(defaultConfig, {
  theme: {
    ...
    tokens: {
      ...
      fonts: {
        heading: { value: "var(--font-geist-sans), Inter, ui-sans-serif, system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Apple Color Emoji', 'Segoe UI Emoji'" },
        body: { value: "var(--font-geist-sans), Inter, ui-sans-serif, system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Apple Color Emoji', 'Segoe UI Emoji'" },
        mono: { value: "var(--font-geist-mono), ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', 'Courier New', monospace" }
      },
      radii: {
        sm: { value: "6px" },
        md: { value: "10px" },
