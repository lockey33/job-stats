...
import SkillSeriesControl from '@/shared/ui/components/molecules/SkillSeriesControl/SkillSeriesControl'
import type { TrendsOptions } from '@/shared/ui/components/molecules/TrendsControls/TrendsControls'
import TrendsControls from '@/shared/ui/components/molecules/TrendsControls/TrendsControls'
import ChartsSkeleton from '@/shared/ui/components/organisms/ChartsSkeleton/ChartsSkeleton'

const Charts = dynamic(() => import('@/shared/ui/components/organisms/Charts/Charts'), {
  ssr: false,
  loading: () => <ChartsSkeleton />,
})
const TopSkillsBarChart = dynamic(
  () => import('@/shared/ui/components/organisms/TopSkillsBarChart/TopSkillsBarChart'),
  { ssr: false },
)
const EmergingSkillsChart = dynamic(
  () => import('@/shared/ui/components/organisms/EmergingSkillsChart/EmergingSkillsChart'),
  { ssr: false },
)
  ...
  return (
    <Section title="Tendances" subtitle="Volume d’offres, TJM moyen et tendances des compétences">
      ...
      <Stack gap="md">
        ...
        <LazyOnVisible placeholder={<ChartsSkeleton />}>
